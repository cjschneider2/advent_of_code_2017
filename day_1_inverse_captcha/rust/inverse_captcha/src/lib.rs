...
mod tests {
    ...
    #[test]
    fn ex_1122 () {
        let res = inverse_captcha("1122");
        assert_eq!(res, 3);
    }

    #[test]
    fn ex_1111 () {
        let res = inverse_captcha("1111");
        assert_eq!(res, 4);
    }

    #[test]
    fn ex_1234 () {
        let res = inverse_captcha("1234");
        assert_eq!(res, 0);
    }

    #[test]
    fn ex_91212129 () {
        let res = inverse_captcha("91212129");
        assert_eq!(res, 9);
    }

    #[test]
    fn test_input () {
        let res = inverse_captcha("21752342814933766938172121674976879111362417653261\
